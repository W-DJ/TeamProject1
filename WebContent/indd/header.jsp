...
<html lang="ko">
  ...
  <body>
	 ...
	 <li><button type="button" id="homeBtn">홈</button></li>
	 	...
	 	<li class="bar">|<li>
	 	<li><button type="button" id="MypageBtn">마이페이지</button></li>
	 	<li class="bar">|<li>
	 	<li><button type="button" id="MemberListBtn">회원목록/수정/탈퇴</button></li>
	 	<li class="bar">|<li>
	 	<li><button type="button" id="InquireBtn">고객센터</button></li>
	 	<li class="bar">|<li>
	 	<li><button type="button" id="PrListBtn">상품게시판</button></li>
	 </ul>
	 <%}%>
	 </div>
	 <!-- div#main-penel-top -->
