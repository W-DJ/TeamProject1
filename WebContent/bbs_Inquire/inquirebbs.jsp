	...
	<div id="wrap">
		...
		<main id="main" class="dFlex">
			...
			<div id="contents" class=bbsList>
				...
				<%
				if (uId_Session == null) { %>
				<button type="button" id="loginPlzBtn" class="inquireBtn">문의하기</button>
				<% } else { %>
				
				
				<button type="button" id="inqBtn" class="inquireBtn"
					onclick="location.href='/bbs_Inquire/write.jsp'">문의하기</button>
					<% } %>


				<iframe src="/bbs_Inquire/list.jsp" frameborder="0" width="100%" scrolling="no"></iframe>
